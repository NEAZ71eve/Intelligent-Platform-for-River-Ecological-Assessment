...
test('patrol page clears private data when the signed-in identity changes', async () => {
  ...
  instance.data.jobs = [{ id: 'private-old-job' }];
  instance.data.imagePath = '/tmp/private.jpg';
  instance.data.location = { latitude: 1, longitude: 2 };

...
- 2026-09-21 同一原生开发者工具已显示天津天气、天津工业大学附近天气、北京 AQI 与暂无预警，选择器包含五地点。北京后端当前已部署并启用真实天气与 DeepSeek，但公网域名仍受拦截、HTTPS 未通、微信 AppSecret 未补齐，本机小程序继续使用本地测试地址。部署状态见 [北京部署与回退](../docs/北京天气版本部署与回退.md)。
